  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-950 flex flex-col items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="w-full max-w-lg bg-white dark:bg-secondary-900 rounded-[2.5rem] shadow-2xl border border-secondary-100 dark:border-secondary-800 overflow-hidden"
      >
        <div className="p-8 md:p-12">
            <div className="flex flex-col items-center text-center mb-10">
                ...
                <h1 className="text-3xl font-black text-secondary-900 dark:text-white mb-3 tracking-tight">Welcome Back</h1>
                <p className="text-secondary-500 dark:text-secondary-400 font-medium tracking-tight">Sign in to your professional account.</p>
            </div>
