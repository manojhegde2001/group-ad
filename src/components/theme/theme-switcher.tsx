            ...
            <div className="grid grid-cols-2 gap-1.5">
              {THEMES.map((t) => (
                <button
                  ...
                  className={`flex items-center justify-center p-2 rounded-md transition-all relative ${colorTheme === t.value
            ...
            <div className="grid gap-1.5">
              {FONTS.map((f) => (
                <button
                  ...
                  className={`flex items-center gap-2.5 text-sm px-3 py-1.5 rounded-md transition-all ${fontFamily === f.value
