...
export function LogoLoader({
  ...
  return (
    <div
      ref={wrapperRef}
      className={cn(
        'vrutta-loader relative flex items-center justify-center select-none shrink-0',
        className
      )}
      style={{
        width: size,
            ...
            return (
              <path
                ...
                style={{
                  ...
                  '--ll-len': `${len}px`,
                  '--ll-fill': color,
                  '--ll-delay': `${(idx * STROKE_STAGGER * duration).toFixed(3)}s`,
                } as React.CSSProperties}
              />
            );
          })}
